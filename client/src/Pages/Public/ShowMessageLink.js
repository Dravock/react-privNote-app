      ...
      <div className='relative  shadow-2xl   '>
        ...
        <section className='px-4 md:px-8 mb-12 mt-8'>
          ...
          <div className="relative w-full bg-black/25">
            <input readOnly={true} value={ process.env.REACT_APP_BASE_URL_PARAM_ID + link_id} id="pn_copy_clip"  className="block p-2.5 w-full z-20 text-sm text-gray-900  rounded-r-lg border-green-500 border-l-2 border-4  focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" />
        ...
        <section className='px-4 md:px-8'>
          <div className='pn__button-group w-full grid grid-cols-12 gap-1  gap-y-2 pb-8'>
              ...
              <a href={`whatsapp://send?text=${process.env.REACT_APP_BASE_URL_PARAM_ID+link_id}`} className="mx-auto w-fit md:w-full order-first md:order-last col-span-12 md:col-span-6 pn__btn bg-[#4FCE5D] hover:bg-[#58d066d2] rounded-lg flex justify-center align-middle relative pr-10 sm:pr-14" title="Auf WhatsApp teilen">
