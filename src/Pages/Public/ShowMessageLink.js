...
function ShowLink(props) {
  const { link_id,loading,loadingText ,closePopUp,  setPopUpState ,secret_key } = props
      ...
      <div className='relative  shadow-2xl   '>
        ...
        <section className='px-4 md:px-8'>
          <div className='pn__button-group w-full grid grid-cols-12 gap-1  gap-y-2 pb-8'>
              ...
              <a href={`whatsapp://send?text=${process.env.REACT_APP_BASE_URL_PARAM_ID_EQUAL}+${link_id}&key='${secret_key}}`} className="mx-auto w-fit md:w-full order-first md:order-last col-span-12 md:col-span-6 pn__btn bg-[#4FCE5D] hover:bg-[#58d066d2] rounded-lg flex justify-center align-middle relative pr-10 sm:pr-14" title="Auf WhatsApp teilen">
